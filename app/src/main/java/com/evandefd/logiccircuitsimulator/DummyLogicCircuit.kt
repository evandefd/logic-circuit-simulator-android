...
class DummyLogicCircuit(override val context: Context, override val tag: String) :
    LogicCircuitComponent(context, tag) {
    ...
    override val contacts: List<Contact> = listOf(
        Contact(1, "In", Contact.GENDER_FEMALE, 0.5f, 1f),
        Contact(2, "Out", Contact.GENDER_FEMALE, 7.5f, 1f)
    )
}